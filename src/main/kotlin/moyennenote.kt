...
fun moyenneAvecNbValeurs(){
    ...
    // le !! dit que l'on prend la responsabilité d'avoir vérifier que la valeur n'est pas nulle. Si c'était nul, ce serait quand meme effectué et cela générerait une erreur
    // c'est l'inverse du ?? qui dit que si c est nul, on effectue pas
    for(i in 1..nbValeur!!){
